...
const PurchaseSuccessModal: React.FC<Props> = ({ course, onClose }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-8 relative text-center animate-in fade-in-0 zoom-in-95">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <p className="text-gray-500 mb-4">You have successfully enrolled in:</p>
